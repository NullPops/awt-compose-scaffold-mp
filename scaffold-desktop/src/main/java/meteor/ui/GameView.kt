...
object GameView {
    ...
    val stretchedMode = mutableStateOf(Properties.get<Boolean>("meteor.stretched", false))
    ...
    fun toggleFullscreen() {
        if (windowState.value == MeteorWindow.floatingState) {
            ...
            Properties.set("meteor.fullscreen", true)
        } else {
            ...
            Properties.set("meteor.fullscreen", false)
            resetWindowSize()
        }
    }
